...
`configmapReload.prometheus.image.tag` | configmap-reload container image tag | `v0.8.0.1`
...
`configmapReload.alertmanager.image.tag` | configmap-reload container image tag | `v0.8.0.1`
...
`server.image.tag` | Prometheus server container image tag | `v2.42.0`
